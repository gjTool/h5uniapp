		...
		<view class="" v-if="index==0" style="overflow-y: scroll !important;flex: 1;">
			...
			<scroll-view scroll-y class="panel-content panel-scroll-box user" :style="{'margin-top':marginTop}">
				...
				<view class="wv-v-h-col-left" style="width: 57.561%;">
					...
					<view class="listFunction">
						<view class="listStrip">
							<image class="wimg" v-if="weatherBodydata && weatherBodydata.wea_img=='yun'" src="/static/weather/yun.png" alt="">
								<image class="wimg" v-else-if="weatherBodydata && weatherBodydata.wea_img=='yu'" src="/static/weather/yu.png" alt="">
									<image class="wimg" v-else-if="weatherBodydata && weatherBodydata.wea_img=='bingbao'" src="/static/weather/bingbao.png" alt="">
										<image class="wimg" v-else-if="weatherBodydata && weatherBodydata.wea_img=='lei'" src="/static/weather/lei.png" alt="">
											<image class="wimg" v-else-if="weatherBodydata && weatherBodydata.wea_img=='longjuanfeng'" src="/static/weather/longjuanfeng.png"
											 alt="">
												<image class="wimg" v-else-if="weatherBodydata && weatherBodydata.wea_img=='qing'" src="/static/weather/qing.png" alt="">
													<image class="wimg" v-else-if="weatherBodydata && weatherBodydata.wea_img=='shachen'" src="/static/weather/shachen.png"
													 alt="">
														<image class="wimg" v-else-if="weatherBodydata && weatherBodydata.wea_img=='wu'" src="/static/weather/wu.png" alt="">
															<image class="wimg" v-else-if="weatherBodydata && weatherBodydata.wea_img=='xue'" src="/static/weather/xue.png" alt="">
																<image class="wimg" v-else-if="weatherBodydata && weatherBodydata.wea_img=='yin'" src="/static/weather/yin.png" alt="">
																	<image class="wimg" v-else-if="weatherBodydata && weatherBodydata.wea_img=='yujiaxue'" src="/static/weather/yujiaxue.png"
																	 alt="">
																		<image class="wimg" v-else src="../../static/weather/cond-a-01d.png">
																			<view class="text">{{weatherBodydata ? weatherBodydata.wea:'' +' '+ weatherBodydata ? weatherBodydata.tem:''}}</view>
						</view>
					</view>
							...
							<view class="wv-nb-now-base">
								<view class="wv-nb-row">
									<view class="wv-nb-col-3 wv-nb-now-base-item">
										<view>{{weatherBodydata.win ? weatherBodydata.win[0]:'' +' '+weatherBodydata.win_speed}}</view>
									</view>
				...
				<view class="wv-v-h-col-right">
					<view class="wv-f-h-row" v-for="(item,index) in forecastList" :key="index">
						<view class="wv-f-h-col-12 wv-f-h-forecast-item">
							<view class="wv-f-h-col-4 wv-f-h-forecast-date" style="width: 42%;">
								<text target="_blank" href="http://m.weather.com.cn/mweather15d/index.shtml?101190101#cj" class="wv-f-h-a">{{item.day+' '+ item.date}}
								</text>
							...
							<view class="listFunction">
								<view class="listStrip">
									<image class="wimg" v-if="item.wea_img=='yun'" src="/static/weather/yun.png" alt="">
										<image class="wimg" v-else-if="item.wea_img=='yu'" src="/static/weather/yu.png" alt="">
											<image class="wimg" v-else-if="item.wea_img=='bingbao'" src="/static/weather/bingbao.png" alt="">
												<image class="wimg" v-else-if="item.wea_img=='lei'" src="/static/weather/lei.png" alt="">
													<image class="wimg" v-else-if="item.wea_img=='longjuanfeng'" src="/static/weather/longjuanfeng.png" alt="">
														<image class="wimg" v-else-if="item.wea_img=='qing'" src="/static/weather/qing.png" alt="">
															<image class="wimg" v-else-if="item.wea_img=='shachen'" src="/static/weather/shachen.png" alt="">
																<image class="wimg" v-else-if="item.wea_img=='wu'" src="/static/weather/wu.png" alt="">
																	<image class="wimg" v-else-if="item.wea_img=='xue'" src="/static/weather/xue.png" alt="">
																		<image class="wimg" v-else-if="item.wea_img=='yin'" src="/static/weather/yin.png" alt="">
																			<image class="wimg" v-else-if="item.wea_img=='yujiaxue'" src="/static/weather/yujiaxue.png" alt="">
																				<image class="wimg" v-else src="../../static/weather/cond-a-02d.png">
																					<view class="text">
					...
					<view v-for="(item,index) in weatherBodydata.index" :key="index">
						<text v-if="index != 1"> {{ item.title.indexOf('中国人民保险<br>')!=-1  ? '':item.title+' '+item.level }}</text>
						<text> {{item.desc}}</text>
						<view class="wv-v-h-col-middle"></view>
					</view>
				</view>
